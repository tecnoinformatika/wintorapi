...
Route::group(['prefix' => 'entidad'], function () {
    ...
    Route::get('user/view/account', [EntidadController::class, 'user_view_account'])->name('app-user-view-account');
    Route::get('user/view/security', [EntidadController::class, 'user_view_security'])->name('app-user-view-security');
