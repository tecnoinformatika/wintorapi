...
Route::group(['prefix' => 'entidad'], function () {
    Route::get('list', [EntidadController::class, 'list'])->name('entidad-list');
    Route::get('directorio/{id}', [EntidadController::class, 'directorio'])->name('directorio');
    Route::get('entidad/{id}', [EntidadController::class, 'entidad'])->name('entidad-entidad');
    Route::get('listado', [EntidadController::class, 'listado'])->name('entidad-listado');
    Route::post('crear', [EntidadController::class, 'crear'])->name('crear');
    Route::post('editar', [EntidadController::class, 'editar'])->name('entidad-editar');
    Route::post('delete/{id}', [EntidadController::class, 'delete'])->name('entidad-delete');
    Route::get('lineastelefonicas/{id}', [EntidadController::class, 'lineastelefonicas'])->name('lineastelefonicas');
    Route::get('lineatelefonica/{id}', [EntidadController::class, 'lineatelefonica'])->name('lineatelefonica');
    Route::get('correos/{id}', [EntidadController::class, 'correos'])->name('Correos');
    Route::get('correo/{id}', [EntidadController::class, 'correo'])->name('Correo');
    Route::post('crearLinea', [EntidadController::class, 'crearLinea'])->name('crearLinea');
    Route::post('crearCorreo', [EntidadController::class, 'crearCorreo'])->name('crearCorreo');
    Route::post('editarLinea', [EntidadController::class, 'editarLinea'])->name('editarLinea');
