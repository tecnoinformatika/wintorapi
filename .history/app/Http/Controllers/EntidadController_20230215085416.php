...
class EntidadController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        $logo = LineasAtencion::where('entidad_id',$entidad->id)->delete();
        $logo = CorreosAtencion::where('entidad_id',$entidad->id)->delete();
        $entidad->delete();
