...
class EntidadController extends Controller
{
    ...
    public function lineatelefonica($id)
    {
        $linea = LineasAtencion::find($id);
        return response::json($linea);
    }
    public function correo($id)
    {
        $linea = CorreosAtencion::find($id);
        return response::json($linea);
    }
    ...
    public function editarLinea(Request $request)
    {
            ...
            $correo = LineasAtencion::find($request->id2)->update([
                'nombre' => $request->nombre,
                'linea' => $request->linea,
                'opcion' => $request->opcion
            ]);
    ...
    {
        try {
            $correo = CorreosAtencion::find($request->id3)->update([
                'nombre' => $request->nombre,
