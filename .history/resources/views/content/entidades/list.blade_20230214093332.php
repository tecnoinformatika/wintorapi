...
@section('page-script')
  ...
  <script>
    ...
    $('body').on('click', '#detalle-entidades', function () {
      ...
      $('#linkpaginaentidad').attr('href',data.linkpagina);
      $('#linkpqrsdentidad').html(data.linkpqrsd);
      $('#linkpqrsdentidad').attr('href',data.linkpqrsd);
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                return (
                  ...
                  '<a href="directorio/'+full['id']+'" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#detalles"  data-id="'+ full['id']+'" id="detalle-entidades">' +
