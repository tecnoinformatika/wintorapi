  ...
  <div class="card">
    ...
    <div class="modal modal-slide-in new-user-modal fade" id="modals-crear">
      <div class="modal-dialog">
        <form class="add-new-user modal-content pt-0" id="data" method="post" enctype="multipart/form-data">
          @csrf
    ...
    <div class="modal modal-slide-in new-user-modal fade" id="modals-editar">
      <div class="modal-dialog">
        <form class="add-new-user modal-content pt-0" id="data1" method="post" enctype="multipart/form-data">
          @csrf
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">×</button>
          <div class="modal-header mb-1">
          ...
          <div class="modal-body flex-grow-1">
            ...
            <div class="mb-1">
              <label for="customFile1" class="form-label">logo de la entidad</label>
              <input class="form-control" type="file" id="logo1"  name="logo">
            </div>
            <img  id="banner2" width="150px" style="background-color: #fff" alt="">
            <div class="mb-1">
              <label for="customFile1" class="form-label">Banner o imagen publicitaria de la entidad</label>
              <input class="form-control" type="file" id="banner1"  name="banner">
            </div>
