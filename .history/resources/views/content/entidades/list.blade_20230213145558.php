      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body px-sm-5 mx-50 pb-4">
            ...
            <img id="logoentidad" alt="avatar" height="38">
            ...
            <ul class="list-group list-group-flush mb-2">
              <li class="list-group-item d-flex align-items-start border-0 px-0">
                ...
                <div class="d-flex align-items-center justify-content-between w-100">
                  ...
                  <div class="me-1">
                    <span id="tipoentidaddetalle"></span>
                  </div>
                  <div class="me-1">
                    <span id="linkpaginaentidad"></span>
                  </div>
                  <div class="me-1">
                    <span id="linkpqrsdentidad"></span>
                  </div>
                </div>
              </li>
...
@section('page-script')
  ...
  <script>
    ...
    $('body').on('click', '#detalle-entidades', function () {
      ...
      $('#btn-update').val("Update");
      $('#id1').val(data.id);
      $('#nombreentidad').val(data.nombre);
      $('#descripcionentidad').val(data.descripcion);
      $('#tipoentidaddetalle').val(data.tipoentidad);
      $('#linkpaginaentidad').val(data.linkpagina);
      $('#linkpqrsentidad').val(data.linkpqrsd);
      $('#logoentidad').attr("src","/storage/"+ data.logo);
      
      $('#detalleshead').css('background-image', 'url(/storage/'+ data.banner +')');
      });
