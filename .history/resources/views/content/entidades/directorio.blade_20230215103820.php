                            ...
                            "<td>"+
                                "<div class='d-inline-flex'>" +
                                    ...
                                    "<div class='dropdown-menu dropdown-menu-end'>" +
                                        ...
                                        "<a href='#' class='dropdown-item delete-record' id='eliminar' data-id='"+ full["id"]+"'>" +
                                        "<i data-feather='trash-2'></i>" +
                                        "Eliminar</a>" +
                                    "</div>" +
                                "</div>" +
                                "<a href='#' data-bs-toggle='modal' data-bs-target='#modals-editar' data-id='"+ full["id"]+"' id='edit-entidades1' 'class='item-edit'>" +
