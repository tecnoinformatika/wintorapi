...
<section class="app-user-list">
  ...
  <div class="card">
    ...
    <div class="modal fade show" id="detalles" tabindex="-1" aria-labelledby="shareProjectTitle" aria-modal="true" role="dialog" style="display: block;">
            ...
            },
            {
              ...
              render: function (data, type, full, meta) {
                return (
                  ...
                  '<a href="javascript:;" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modals-editar">' +
