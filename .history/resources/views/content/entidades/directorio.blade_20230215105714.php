...
@section('page-script')
  ...
  <script>
    ...
    $('body').on('click', '#eliminar-lineas', function () {
      var entidad_id = $(this).data('id');

      $.get('/entidad/lineaatencion/'+entidad_id, function (data) {
      console.log(data);
      $('#btn-update').val("Update");
      $('#id1').val(data.id);
      $('#nombre1').val(data.nombre);
      $('#linea1').val(data.linkpagina);
      $('#opcion1').val(data.linkpqrsd);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var rows ="<tr>" +
                            ...
                            "<td id='nombre1'>" + item.nombre + "</td>" +
                            "<td id='telefono1'>" + item.linea + "</td>" +
                            "<td id='opcion2'>" + item.opcion + "</td>" +
                            "<td>"+
                                   "<a href='#' class='delete-record' id='eliminar-lineas' data-id='"+item.id+"'>" +
                                        "</i>" +
                                        "Eliminar"+
                                    "</a><br>" +

                                "<a href='#' data-bs-toggle='modal' data-bs-target='#modals-editar-lineas' data-id='"+item.id+"' id='edit-lineas' 'class='item-edit'>" +
                                "Editar" +
                                "</a>"
                            "</td>"+
                        "</tr>";
