...
Route::group(['prefix' => 'entidad'], function () {
    ...
    Route::get('lineastelefonicas', [EntidadController::class, 'lineastelefonicas'])->name('lineastelefonicas');
    Route::get('correos', [EntidadController::class, 'correos'])->name('Correos');
