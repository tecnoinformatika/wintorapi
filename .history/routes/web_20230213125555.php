...
Route::group(['prefix' => 'entidad'], function () {
    ...
    Route::get('editar', [EntidadController::class, 'editar'])->name('editar');
    Route::get('user/view/billing', [EntidadController::class, 'user_view_billing'])->name('app-user-view-billing');
    Route::get('user/view/notifications', [EntidadController::class, 'user_view_notifications'])->name('app-user-view-notifications');
    Route::get('user/view/connections', [EntidadController::class, 'user_view_connections'])->name('app-user-view-connections');
});
/* Route UI */
