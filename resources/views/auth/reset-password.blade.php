    ...
    <div class="auth-inner my-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <p class="card-text mb-2">Tu nueva contraseña debe ser diferente a la anterior</p>
          ...
          <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="mb-1">
              <div class="d-flex justify-content-between">
                <label class="form-label" for="reset-password-confirm">Confirma la nueva contraseña</label>
              </div>
            ...
            <button type="submit" class="btn btn-primary w-100" tabindex="4">Cambiar contraseña</button>
          </form>
